...
<template>
    ...
    <div class="flex h-full flex-1 flex-col gap-6 p-4 md:p-6">
        ...
        <div
            ...
            class="rounded-2xl border border-dashed border-border bg-card p-10 text-center"
        >
        ...
        <div v-else class="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
            ...
            >
                <div
                    class="h-1 bg-gradient-to-r from-teal-500 to-teal-300 dark:to-teal-700"
                />
                <div class="p-5">
                    ...
                    <div class="mt-4 space-y-2 text-sm">
                        ...
                        <div
                            v-if="classItem.school_year || classItem.semester"
                            class="flex items-center gap-2"
                        >
                            <span
                                class="text-xs font-semibold tracking-wide text-muted-foreground uppercase"
                    ...
                    <div
                        v-if="classItem.research_papers?.length"
