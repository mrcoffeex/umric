...
import { ChevronLeft, GraduationCap, Users } from 'lucide-vue-next';
...
<template>
    ...
    <div class="flex h-full flex-1 flex-col gap-6 p-4 md:p-6">
        ...
        <div class="overflow-hidden rounded-2xl border border-border bg-card">
            ...
            <div class="p-5 md:p-6">
                <div class="flex items-center gap-3">
                    <div
                        class="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-teal-50 dark:bg-teal-950/30"
                    >
        ...
        <!-- Classmates list -->
        <div
            class="flex max-h-[600px] flex-col overflow-hidden rounded-2xl border border-border bg-card"
        >
            <div
                ...
                <ul v-else class="divide-y divide-border/50">
                    ...
                    >
                        ...
                        >
                            ...
                            <div
                                v-else
                                class="flex h-full w-full items-center justify-center bg-gradient-to-br from-teal-400 to-orange-400 text-[11px] font-bold text-white"
                            >
                                {{ getInitials(s.name) }}
                            </div>
                        </div>
                        ...
                        <span
                            ...
                            >Joined {{ formatDate(s.joined_at) }}</span
                        >
                    </li>
                </ul>
            </div>
