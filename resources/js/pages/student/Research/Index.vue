...
<template>
    ...
    <div class="flex h-full flex-1 flex-col gap-6 p-4 md:p-6">
        ...
        <div v-if="filteredPapers.length > 0" class="space-y-3">
            <a
                ...
                @click.prevent="
                    router.visit(student.research.show.url(paper.id))
                "
            >
                <div
                    class="flex flex-col gap-3 p-5 sm:flex-row sm:items-center sm:gap-5"
                >
                    <!-- Main info -->
                    <div class="min-w-0 flex-1">
                        <div class="flex flex-wrap items-center gap-2">
                            ...
                            <span
                                v-if="!isOwner(paper)"
                                class="rounded-full bg-teal-50 px-2 py-0.5 text-[10px] font-semibold text-teal-700 dark:bg-teal-950/30 dark:text-teal-300"
                            >
                                Co-proponent
                            </span>
                        </div>
                        ...
                        >
                            ...
                            <span v-if="paper.adviser"
                                >Adviser: {{ paper.adviser.name }}</span
                            >
                        ...
                        <div class="mt-2.5 flex items-center gap-2">
                            ...
                            >
                                <div
                                    ...
                                    :style="{
                                        width: progressPercent(paper) + '%',
                                    }"
                                />
                            </div>
                            <span
                                class="text-[10px] font-semibold text-muted-foreground"
                                >{{ progressPercent(paper) }}%</span
                            >
                        </div>
                    </div>
                    ...
                    <div class="flex shrink-0 items-center gap-2">
                        ...
                        <template v-if="canEdit(paper)">
                            <button
                                ...
                                @click.stop.prevent="
                                    router.visit(
                                        student.research.edit.url(paper.id),
                                    )
                                "
                            >
            ...
            <p class="mb-5 text-sm text-muted-foreground">
                {{
                    searchQuery
                        ...
                        : 'Submit your first title proposal to get started.'
                }}
            </p>
            <button
                v-if="!searchQuery"
    ...
    <Teleport to="body">
        ...
        >
            <div
                class="w-full max-w-md rounded-2xl border border-red-200 bg-card shadow-xl dark:border-red-900"
            >
                <div class="border-b border-red-200 p-5 dark:border-red-900">
                    <div class="flex items-center gap-3">
                        <div
                            class="flex h-10 w-10 items-center justify-center rounded-full bg-red-50 dark:bg-red-950/30"
                        >
                ...
                <div class="space-y-4 p-5">
                    <p class="text-sm text-foreground">
                        ...
                        <strong>"{{ deletePaper?.title }}"</strong> and all its
                        tracking records.
                    </p>
                    ...
                    <div>
                        ...
                        >
                            Type <strong class="text-red-500">DELETE</strong> to
                            confirm
                        </label>
                        <input
