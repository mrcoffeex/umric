...
import { index as calendarIndex } from '@/routes/student/defense-calendar';
    ...
    <div class="flex h-full flex-col gap-5 p-4 md:p-6">
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xs text-muted-foreground">
                        Your scheduled title, outline, and final defenses
                    </p>
                </div>
            </div>
        ...
        >
            ...
            <p class="mt-1 text-xs text-muted-foreground">
                You have no outline or final defense schedule for
                {{ MONTH_NAMES[props.month - 1] }} {{ props.year }}.
            </p>
        </div>
