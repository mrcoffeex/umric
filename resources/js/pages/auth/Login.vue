...
<template>
    ...
    <div
        ...
        :class="status.includes('pending') || status.includes('approval')
    ...
    >
        ...
        <div class="flex items-center gap-2">
            ...
            <label for="remember" class="cursor-pointer text-sm text-gray-600 dark:text-gray-400">Remember me</label>
        </div>
        ...
        <p v-if="canRegister" class="text-center text-sm text-gray-500 dark:text-gray-400">
            Don't have an account?
            <TextLink :href="register()" :tabindex="5" class="font-medium text-orange-600 hover:text-orange-500">Sign up</TextLink>
        </p>
    </Form>
</template>
