...
<template>
    ...
    <!-- Heading -->
    <div class="mb-6">
        <h2 class="text-lg font-semibold text-gray-900 dark:text-gray-100">Create your account</h2>
        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Join UMRIC to track and manage research</p>
    </div>

    <!-- Role toggle -->
    <div class="mb-6 flex rounded-full border border-gray-200 bg-gray-50 p-1 dark:border-gray-700 dark:bg-gray-800">
        <button
            type="button"
            ...
            :class="roleTab === 'student' ? 'bg-white text-orange-600 shadow-sm dark:bg-gray-700 dark:text-orange-400' : 'text-gray-500 hover:text-gray-700 dark:text-gray-400'"
        >
        ...
        <button
            ...
            class="flex flex-1 items-center justify-center gap-1.5 rounded-full py-2 text-sm font-medium transition-all duration-200"
            :class="roleTab === 'faculty' ? 'bg-white text-teal-600 shadow-sm dark:bg-gray-700 dark:text-teal-400' : 'text-gray-500 hover:text-gray-700 dark:text-gray-400'"
        >
    ...
    <div class="relative my-5 flex items-center gap-3">
        ...
        <span class="text-xs uppercase tracking-wide text-gray-400">or fill in manually</span>
        <div class="h-px flex-1 bg-gray-200 dark:bg-gray-700"></div>
    </div>
    ...
    >
        ...
        <div class="grid gap-1.5">
            ...
            <input
                ...
                class="h-10 w-full rounded-lg border border-gray-200 bg-white px-3 text-sm text-gray-900 placeholder:text-gray-400 focus:border-orange-400 focus:outline-none focus:ring-2 focus:ring-orange-400/20 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-100 dark:placeholder:text-gray-500"
            />
        ...
        <p class="text-center text-sm text-gray-500 dark:text-gray-400">
            ...
            <TextLink :href="login()" class="font-medium text-orange-600 hover:text-orange-500" :tabindex="8">Log in</TextLink>
        </p>
    </Form>
</template>
