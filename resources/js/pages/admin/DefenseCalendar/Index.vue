...
import { show as researchShow } from '@/routes/admin/research';
...
<template>
    <div class="flex h-full flex-col gap-5 p-4 md:p-6">
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xs text-muted-foreground">
                        Outline, title, and final defenses
                    </p>
                </div>
            </div>
            <!-- Legend -->
        ...
        <!-- Overflow: remaining schedules for a busy day -->
