    ...
    <div class="flex h-full flex-1 flex-col gap-6 p-4 md:p-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-0.5 text-sm text-muted-foreground">Add a new admin or staff account.</p>
            </div>
            <Link
        ...
        <div class="mx-auto w-full max-w-lg">
            <form @submit.prevent="submit" class="overflow-hidden rounded-2xl border border-border bg-card">
                <div class="flex items-center gap-3 border-b border-border p-5">
                    ...
                    <div>
                        <p class="font-semibold text-foreground">Account Details</p>
                        <p class="text-xs text-muted-foreground">The user will be immediately active upon creation.</p>
                    </div>
                </div>
                ...
                <div class="space-y-5 p-5">
                    <!-- Role -->
                    <div>
                        <label class="mb-1.5 block text-sm font-semibold text-foreground">Role</label>
                        <div class="flex gap-3">
                            <label
                                v-for="option in [{ value: 'staff', label: 'Staff' }, { value: 'admin', label: 'Admin' }]"
                                :key="option.value"
                                :class="[
                            ...
                            >
                                ...
                                <span
                                    :class="[
                                        ...
                                        form.role === option.value ? 'border-orange-500 bg-orange-500' : 'border-border',
                                    ]"
                                />
                    ...
                    <!-- Name -->
                    <div>
                        <label for="name" class="mb-1.5 block text-sm font-semibold text-foreground">Full Name</label>
                        <input
                            id="name"
                            v-model="form.name"
                            type="text"
                            ...
                            :class="[
                                ...
                                form.errors.name ? 'border-red-400 focus:border-red-400' : 'border-input focus:border-ring',
                            ]"
                        />
                    ...
                    <div>
                        ...
                        <input
                            ...
                            :class="[
                                'w-full rounded-xl border bg-background px-3 py-2.5 text-sm outline-none placeholder:text-muted-foreground focus:ring-2 focus:ring-ring/30',
                                form.errors.email ? 'border-red-400 focus:border-red-400' : 'border-input focus:border-ring',
                            ]"
                        />
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input
                                ...
                                :class="[
                                    'w-full rounded-xl border bg-background py-2.5 pl-3 pr-10 text-sm outline-none placeholder:text-muted-foreground focus:ring-2 focus:ring-ring/30',
                                    form.errors.password ? 'border-red-400 focus:border-red-400' : 'border-input focus:border-ring',
                                ]"
                            />
                            <button
                                type="button"
                    ...
                    <!-- Confirm Password -->
                    <div>
                        <label for="password_confirmation" class="mb-1.5 block text-sm font-semibold text-foreground">Confirm Password</label>
                        <div class="relative">
                            <input
                                ...
                                :class="[
                                    'w-full rounded-xl border bg-background py-2.5 pl-3 pr-10 text-sm outline-none placeholder:text-muted-foreground focus:ring-2 focus:ring-ring/30',
                                    form.errors.password_confirmation ? 'border-red-400 focus:border-red-400' : 'border-input focus:border-ring',
                                ]"
                            />
                            <button
                                type="button"
