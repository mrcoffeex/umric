  ...
  <div class="tracking-timeline">
    <div class="timeline-track">
      ...
      <div
        ...
        :key="stage"
        class="timeline-dot"
        :class="{ completed: index < currentStageIndex, current: index === currentStageIndex }"
      >
    ...
    <div class="timeline-history">
      ...
      >
        ...
        <div class="history-content">
          <div class="history-title">{{ stageLabels[record.status] }}</div>
...
const stages = ['submitted', 'under_review', 'approved', 'presented', 'published', 'archived']
...
const currentStageIndex = computed(() =>
  stages.indexOf(props.currentStatus)
)
