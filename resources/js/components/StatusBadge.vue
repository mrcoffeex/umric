<template>
  <div class="status-badge" :class="{ 'status-pulse': props.status === 'under_review', 'status-badge-dark': isDark }" :style="{ color: badgeColor }">
...
const config = computed(() => statusConfig[props.status] ?? { label: props.status, color: '#6b7280' })
